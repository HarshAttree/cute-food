...
<div>
	...
	<p style="margin-left:5%;">Status<meter style="width:100px;height:20px;" low="45" min="10" max="100" value="90">            </meter></p> 
	...
	<br><br><br>
	<marquee width="40%" direction="left" height="10%"><strong>
    Your problem will be solved with in an hour :)
 </strong></marquee>
 <marquee width="50%" direction="right" height="10%"><strong>
    Rated 4.5 star on Google
 </strong></marquee>
