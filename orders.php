                ...
                <div>
					...
					while($row = mysqli_fetch_array($sql))
					{
						...
						echo '<li class="collection-item avatar">
							  ...
							  <details>
							  <summary>
                              <span class="collection-header">Order No. '.$row['id'].'</span></summary>
						...
						while($row1 = mysqli_fetch_array($sql1))
						{
							...
							$id = $row1['order_id'];
								...
								echo '<form action="routers/cancel-order.php" method="post">
										...
										<button class="btn waves-effect waves-light right submit" style="background-color:#33cc00;" type="submit" name="action">Cancel Order
